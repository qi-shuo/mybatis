...
public class Configuration {
  ...
  /**
   * MappedStatement,映射
   * key值就是mapper.xml的${namespace}.${id}(id是每一个标签的id属性比如<select id="test"></select>,id就是test)
   */
  ...
  public Executor newExecutor(Transaction transaction, ExecutorType executorType) {
    ...
    //cacheEnabled默认是开启的,所以肯定会被CachingExecutor包装一层
    if (cacheEnabled) {
  ...
  public void addMappers(String packageName) {
    //扫描该包下所有的Mapper接口,并添加到mapperRegistry
